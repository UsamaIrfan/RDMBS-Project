const productData = [
    { id: 0, name: 'CHECK PRINT SHIRT', registered: '2018/01/01', catagory: 'Mens Wear', status: 'In Stock' },
    { id: 1, name: 'GLORIA HIGH LOGO SNEAKER', registered: '2018/01/01', catagory: 'Foot Wear', status: 'In Stock' },
    { id: 2, name: 'CATE RIGID BAG', registered: '2018/02/01', catagory: 'Women Wear', status: 'In Stock' },
    { id: 3, name: 'GUESS CONNECT WATCH', registered: '2018/02/01', catagory: 'Watches', status: 'In Stock' },
    { id: 4, name: "'70s RETRO GLAM KEFIAH", registered: '2018/03/01', catagory: 'Cosmetics', status: 'In Stock' },
]
